...
#             max_class = sum(self.increments)
    ...
    def _setup_data(self, datasets, path, random_order=False, seed=1, increment=10, validation_split=0.):
        ...
        for dataset in datasets:
            ...
            if(self.dataset_name=="cub200" or self.dataset_name=="cifar100" or self.dataset_name=="mnist"  or self.dataset_name=="caltech101"  or self.dataset_name=="omniglot"  or self.dataset_name=="celeb"):
...
class iCIFAR10(DataHandler):
    base_dataset = dset.cifar.CIFAR10
    train_transforms = [
...
class iCIFAR100(DataHandler):
    base_dataset = dset.cifar.CIFAR100
    train_transforms = [
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.RandomRotation(10),
